...
<h3 align="center">Frontend-разработчик с 5-летним опытом</h3>

---

### 🚀 Обо мне
- 💻 Разрабатываю быстрые и удобные веб-приложения
- 🔥 Специализация: **Frontend**, но также работаю с backend-технологиями
- 📈 Опыт коммерческой разработки — **5 лет**
- 🎯 Люблю продумывать архитектуру и оптимизировать UI
...
![Bitrix](https://img.shields.io/badge/-Bitrix-1F5D90?logo=bitrix24&logoColor=fff)
...
![JSZip](https://img.shields.io/badge/-JSZip-4285F4?logo=zip&logoColor=fff)
![DnD Kit](https://img.shields.io/badge/-DnD%20Kit-000000?logo=dnd&logoColor=fff)
